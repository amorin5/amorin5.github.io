...
class Book {
    ...
    draw() {
        ...
        var targetCamera = this.vec3.fromValues(0,0,0); 
        var upCamera = this.vec3.fromValues(0,100,0); 
        ...
        glMatrix.mat4.fromTranslation(Tviewport,[300,300,0]);  
        glMatrix.mat4.scale(Tviewport,Tviewport,[100,-100,1]); 
